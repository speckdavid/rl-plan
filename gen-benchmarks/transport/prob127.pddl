...
(define (problem transport-city-sequential-31nodes-1000size-4degree-100mindistance-3trucks-10packages-1seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (= (road-length city-loc-14 city-loc-4) 14)
  ; 932,686 -> 794,690
  (road city-loc-4 city-loc-14)
  (= (road-length city-loc-4 city-loc-14) 14)
  ; 794,690 -> 761,816
  ...
  (= (road-length city-loc-20 city-loc-2) 14)
  ; 990,432 -> 860,402
  (road city-loc-2 city-loc-20)
  (= (road-length city-loc-2 city-loc-20) 14)
  ; 860,402 -> 755,383
  ...
  (= (road-length city-loc-23 city-loc-3) 25)
  ; 519,849 -> 315,720
  (road city-loc-3 city-loc-23)
  (= (road-length city-loc-3 city-loc-23) 25)
  ; 315,720 -> 290,601
  ...
  (= (road-length city-loc-26 city-loc-1) 17)
  ; 512,958 -> 352,975
  (road city-loc-1 city-loc-26)
  (= (road-length city-loc-1 city-loc-26) 17)
  ; 352,975 -> 519,849
  ...
  (= (road-length city-loc-27 city-loc-2) 21)
  ; 990,432 -> 867,591
  (road city-loc-2 city-loc-27)
  (= (road-length city-loc-2 city-loc-27) 21)
  ; 867,591 -> 932,686
  (road city-loc-27 city-loc-4)
  (= (road-length city-loc-27 city-loc-4) 12)
  ; 932,686 -> 867,591
  (road city-loc-4 city-loc-27)
  (= (road-length city-loc-4 city-loc-27) 12)
  ; 867,591 -> 794,690
  ...
  (= (road-length city-loc-28 city-loc-2) 17)
  ; 990,432 -> 931,275
  (road city-loc-2 city-loc-28)
  (= (road-length city-loc-2 city-loc-28) 17)
  ; 931,275 -> 755,383
  ...
  (= (road-length city-loc-29 city-loc-1) 12)
  ; 512,958 -> 623,980
  (road city-loc-1 city-loc-29)
  (= (road-length city-loc-1 city-loc-29) 12)
  ; 623,980 -> 519,849
  (road city-loc-29 city-loc-3)
  (= (road-length city-loc-29 city-loc-3) 17)
  ; 519,849 -> 623,980
  (road city-loc-3 city-loc-29)
  (= (road-length city-loc-3 city-loc-29) 17)
  ; 623,980 -> 761,816
  ...
  (= (road-length city-loc-30 city-loc-1) 20)
  ; 512,958 -> 392,802
  (road city-loc-1 city-loc-30)
  (= (road-length city-loc-1 city-loc-30) 20)
  ; 392,802 -> 519,849
  (road city-loc-30 city-loc-3)
  (= (road-length city-loc-30 city-loc-3) 14)
  ; 519,849 -> 392,802
  (road city-loc-3 city-loc-30)
  (= (road-length city-loc-3 city-loc-30) 14)
  ; 392,802 -> 290,601
  ...
  (= (road-length city-loc-31 city-loc-4) 17)
  ; 932,686 -> 877,840
  (road city-loc-4 city-loc-31)
  (= (road-length city-loc-4 city-loc-31) 17)
  ; 877,840 -> 996,903
  (road city-loc-31 city-loc-7)
  (= (road-length city-loc-31 city-loc-7) 14)
  ; 996,903 -> 877,840
  (road city-loc-7 city-loc-31)
  (= (road-length city-loc-7 city-loc-31) 14)
  ; 877,840 -> 761,816
