...
(define (problem transport-city-sequential-42nodes-1000size-4degree-100mindistance-4trucks-20packages-1seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (= (road-length city-loc-42 city-loc-5) 12)
  ; 507,779 -> 392,802
  (road city-loc-5 city-loc-42)
  (= (road-length city-loc-5 city-loc-42) 12)
  ; 392,802 -> 443,622
  ...
  (= (road-length city-loc-42 city-loc-23) 17)
  ; 227,782 -> 392,802
  (road city-loc-23 city-loc-42)
  (= (road-length city-loc-23 city-loc-42) 17)
  ; 392,802 -> 448,961
  ...
  (= (road-length city-loc-42 city-loc-36) 12)
  ; 315,720 -> 392,802
  (road city-loc-36 city-loc-42)
  (= (road-length city-loc-36 city-loc-42) 12)
