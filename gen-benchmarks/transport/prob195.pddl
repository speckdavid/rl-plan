; Transport city-sequential-23nodes-1000size-4degree-100mindistance-3trucks-14packages-1seed

(define (problem transport-city-sequential-23nodes-1000size-4degree-100mindistance-3trucks-14packages-1seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (= (road-length city-loc-19 city-loc-13) 29)
  ; 456,272 -> 554,9
  (road city-loc-13 city-loc-19)
  (= (road-length city-loc-13 city-loc-19) 29)
  ; 961,902 -> 867,821
  ...
  (= (road-length city-loc-23 city-loc-5) 28)
  ; 507,779 -> 227,782
  (road city-loc-5 city-loc-23)
  (= (road-length city-loc-5 city-loc-23) 28)
  ; 227,782 -> 29,914
  ...
  (= (road-length city-loc-23 city-loc-11) 27)
  ; 443,622 -> 227,782
  (road city-loc-11 city-loc-23)
  (= (road-length city-loc-11 city-loc-23) 27)
  ; 227,782 -> 2,712
