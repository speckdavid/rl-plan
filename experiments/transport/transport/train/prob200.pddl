; Transport city-sequential-23nodes-1000size-4degree-100mindistance-4trucks-9packages-1seed

(define (problem transport-city-sequential-23nodes-1000size-4degree-100mindistance-4trucks-9packages-1seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
